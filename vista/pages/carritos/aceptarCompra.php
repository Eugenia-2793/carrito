...
/***  ACEPTAR ***/
if ($objCompraEstado->aceptarCompra($datos)) {
    $resp = true;
} else {
    $mensaje = "<b>ERROR: </b>";
}
...
if ($resp) {
    $mensaje = "La acción <b> Aceptar Compra</b> se realizo correctamente.";
} else {
    $mensaje .= "La acción <b> Aceptar Compra</b> no pudo concretarse.";
}
